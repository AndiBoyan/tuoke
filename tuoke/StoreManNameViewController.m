...
@interface StoreManNameViewController ()
{
    UITextField *field;
}
@end

@implementation StoreManNameViewController
...
-(void)save
{
    if (field.text.length <= 0) {
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"店主姓名不能为空" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alert show];
