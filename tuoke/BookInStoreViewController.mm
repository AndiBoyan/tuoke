...
-(void)bookIn
{
    ...
    //设置请求体
    NSString *param=[NSString stringWithFormat:@"Params={\"authCode\":\"%@\",\"JsonInfo\":{\"CityName\":\"%@\",\"Address\":\"%@\",\"DeptName\":\"%@\",\"DeptCategoryId\":%ld,\"DeptImgPath\":\"%@\",\"DeptImgFid\":\"%@\",\"UserInfo_DZ\":{\"UserName\":\"%@\",\"Mobile\":\"%@\",\"UserCategoryId\":1,\"CardFrontImgPath\":\"%@\",\"CardFrontImgFid\":\"%@\",\"CardBackImgPath\":\"%@\",\"CardBackImgFid\":\"%@\"},\"UserInfo_FTR\":{\"UserName\":\"%@\",\"Mobile\":\"%@\",\"UserCategoryId\":%ld}}}&Command=tuoke/TK_DepartmentCreate",[self encodeToPercentEscapeString:authCode],city,address,storeName,storeManType,storeImageFileId,storeImagePath,storeManName,storeManPhone,storeImageCard1FileId,storeImageCard1Path,storeImageCard2FileId,storeImageCard2Path,visitName,visitPhone,visitManType];
