...
@interface VisitPhoneViewController ()
{
    UITextField *field;
}
@end

@implementation VisitPhoneViewController
...
-(void)save
{
    if (field.text.length <= 0) {
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"访谈人手机号码不能为空" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alert show];
